 ...
 */
public class DeviceParameterUpdatedSupport implements Serializable {

    private static transient final Logger LOGGER = LoggerFactory.getLogger(DeviceParameterUpdatedSupport.class);
